        ...
        <header className="flex items-center justify-between p-4 bg-white border-b border-gray-200 shadow-sm">
            ...
            <div className="flex items-center gap-2 md:gap-3">
                ...
                <button
                    ...
                    className="p-2 rounded-lg text-gray-500 hover:bg-gray-200 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-sky-400 transition-colors duration-200"
